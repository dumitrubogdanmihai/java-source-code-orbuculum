...
public class Indexer {
	 ...
	 * @throws IOException
	 */
	public void indexAll(String rootPath) throws SolrServerException, IOException {
	...
	private void index(
		...
		document.addField("id", IdProvider.getId(unit, clazz, method));
		document.addField("type", "method");
		document.addField("text", method.toString());
